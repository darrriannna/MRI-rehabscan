...
const AboutPage = () => {
  return (
    ...
    <p className='text-about p-4'>RehabScan är en digital hälsoklinik som erbjuder radiologiska undersökningar som magnetresonans, CT röntgen och konventionell röntgen över hela Sverige.</p>
