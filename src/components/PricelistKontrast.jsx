...
const PricelistK = () => {  const services = [
        ...
        { id: 40, name: 'MR Helkropp (K)', price: '18 200kr' },
        ...
        { id: 54, name: 'MR Buk (K)', price: '8 500kr' },
        { id: 55, name: 'MR Hals/larynx (K)', price: '7 800kr' },
        { id: 56, name: 'MR Nacke/Halsrygg (K)', price: '5 900kr' },
        { id: 57, name: 'MR Helrygg (K)', price: '11 000kr' },
        { id: 58, name: 'MR Hjärna (K)', price: '6 200kr' },
        { id: 59, name: 'MR Käkled (K)', price: '6 800kr' },
        { id: 60, name: 'MR Höger Knä (K)', price: '5 900kr' },
        { id: 61, name: 'MR Orbita (K)', price: '6 800kr' },
        { id: 62, name: 'MR Prostata (K)', price: '7 800kr' },
